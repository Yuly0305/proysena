...
@yield('content')
	<div class="row">
		      ...
		      <div class="enlace">
				...
				<div class="enlace">
					<a class="dropdown-item" href="trimestres.php">
			          <span class="text-light mt-1"><i class="fa fa-align-left fa-sm fa-fw mr-2 text-gray-400 text-light"></i>Trimestre</span>
			      	</a>
				</div>
		...
		<div class="col-8 lista-index">
			...
			<h1>
				<i class="fa fa-users"></i>Lista de Programas</h1>
			<hr>
